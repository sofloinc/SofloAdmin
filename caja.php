...
<body>
  <div class="container">
    ...
    <nav class="nav justify-content-center">
      <a class="nav-link active" href="ingreso.php">Ingreso</a>
  ...
  <div class="container">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form action="./operaciones/ing_caja.php" method="post">

          <div class="form-group">
            <label for="">Artículo</label>
            <input type="text" class="form-control" name="articulo" id="" aria-describedby="helpId" placeholder="Articulo">
            <small id="helpId" class="form-text text-muted">Tipo y descripción</small>
          </div>
          <div class="form-group">
            <label for="">Valor</label>
            <input type="text" class="form-control" name="precio_venta" id="" aria-describedby="helpId" placeholder="$">
